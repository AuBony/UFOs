# Titre : Application Shiny OVNIs SERVER
...
source("carte.r")
source("summary.R")
tableau_clean <- read.csv("./ana_text_tableau.csv", na.strings="", dec=".", sep=";")
...
shinyServer(function(input, output) {
  ...
  # >Etude temporelle des donn̩es par forme
